...
def main_menu():
    while True:
        ...
        print(f"{YELLOW}{BOLD}[1]{RESET}  🧩  Daliy Applications ")
        print(f"{YELLOW}{BOLD}[2]{RESET}  🐉  Kali Default tools")
        print(f"{YELLOW}{BOLD}[3]{RESET}  🧰  Kali Selactive Tools")
        print(f"{YELLOW}{BOLD}[4]{RESET}  🔗  Add Kali Repository")
        print(f"{YELLOW}{BOLD}[5]{RESET}  🎨  Themes, Grub, gmone")
        print(f"{YELLOW}{BOLD}[6]{RESET}  👋  Uninstall tools")
        ...
        if choice == '1':
            ...
            run_script("core/ubuntu/repo.py")
        elif choice == '5':
            run_script("core/ubuntu/ubuntu_theme.sh")
        elif choice == '6':
